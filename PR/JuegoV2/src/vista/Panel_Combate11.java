...
public class Panel_Combate11 extends JPanel {
    ...
    public Panel_Combate11(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Kaido2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE12"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            case "Gomu Gomu no Kong Rifle":
                mostrarGif("Luffy-Kong Rifle.gif");
                break;
            case "Gomu Gomu no Kong Gun":
                mostrarGif("Luffy-Kong Gun.gif");
                break;
            case "Gomu Gomu no Kong Gatling":
                mostrarGif("Luffy-Kong Gatling.gif");
                break;
            case "Gomu Gomu no Red Roc":
                mostrarGif("Luffy-Red Roc.gif");
                break;
            default:
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 400;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
