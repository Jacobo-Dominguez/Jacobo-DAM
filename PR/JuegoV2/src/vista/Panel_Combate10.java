...
public class Panel_Combate10 extends JPanel {
    ...
    public Panel_Combate10(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Katakuri2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE11"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            case "Gomu Gomu no Jet Culverin":
                mostrarGif("Luffy-Jet Culverin.gif");
                break;
            case "Gomu Gomu no King Kobra":
                mostrarGif("Luffy-King Kobra.gif");
                break;
            case "Gomu Gomu no Black Mamba":
                mostrarGif("Luffy-Black Mamba.gif");
                break;
    ...
    private void mostrarGifEnemigo(String nombreAtaque) {
        ...
        switch (nombreAtaque) {
            case "Zan Giri Mochi":
                nombreGif = "Katakuri-Zan Giri Mochi.gif";
                break;
            case "Chikara Mochi":
                nombreGif = "Katakuri-Chikara Mochi.gif";
                break;
            case "Yaku Mochi":
                nombreGif = "Katakuri-Yaku Mochi.gif";
                break;
            case "Amadare Mochi":
                nombreGif = "Katakuri-Amadare Mochi.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 330;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
