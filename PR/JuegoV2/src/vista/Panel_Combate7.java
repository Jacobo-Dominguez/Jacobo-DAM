...
public class Panel_Combate7 extends JPanel {
    ...
    public Panel_Combate7(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Moria2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE8"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            ...
            case "Gomu Gomu no Jet Gatling":
                ...
                break;
            case "Gomu Gomu no Jet Shell":
                mostrarGif("Luffy-Jet Shell.gif");
                break;
            default:
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 220;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
