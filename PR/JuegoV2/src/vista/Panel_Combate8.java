...
public class Panel_Combate8 extends JPanel {
    ...
    public Panel_Combate8(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Hody2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE9"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            case "Gomu Gomu no Elephant Gatling":
                mostrarGif("Luffy-Elephant Gatling.gif");
                break;
            case "Gomu Gomu no Jet Bazooka":
                mostrarGif("Luffy-Jet Bazooka.gif");
                break;
            case "Gomu Gomu no Jet Gatling":
                mostrarGif("Luffy-Jet Gatling.gif");
                break;
            case "Gomu Gomu no Red Hawk":
                mostrarGif("Luffy-Red Hawk primero.gif");
                break;
            default:
    ...
    private void mostrarGifEnemigo(String nombreAtaque) {
        ...
        switch (nombreAtaque) {
            case "Fishman Karate":
                nombreGif = "Hody-Fishman Karate.gif";
                break;
            case "Water Heart":
                nombreGif = "Hody-Water Heart.gif";
                break;
            case "Water Shot":
                nombreGif = "Hody-Water Shot.gif";
                break;
            case "Water Kick":
                nombreGif = "Hody-Water Kick.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 240;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
