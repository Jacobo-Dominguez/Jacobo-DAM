...
public class Panel_Combate4 extends JPanel {
    ...
    public Panel_Combate4(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Crocodile2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE5"));
    ...
    private void mostrarGifEnemigo(String nombreAtaque) {
        ...
        switch (nombreAtaque) {
            case "Desert Spada":
                nombreGif = "Crocodile-Desert Spada.gif";
                break;
            case "Desert Girasole":
                nombreGif = "Crocodile-Desert Girasole.gif";
                break;
            case "Sables Pesado":
                nombreGif = "Crocodile-Sables Pesado.gif";
                break;
            case "Ground Death":
                nombreGif = "Crocodile-Ground Death.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
