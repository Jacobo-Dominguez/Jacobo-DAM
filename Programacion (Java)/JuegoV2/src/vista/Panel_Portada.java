...
public class Panel_Portada extends JPanel {

    public Panel_Portada(JFrame_General frame) {
        setLayout(new BorderLayout()); // Configurar el Layout (por ejemplo, FlowLayout para que el botón esté en el centro)
        JButton boton = new JButton("Iniciar Aventura"); // Crear el botón
        // Añadir un ActionListener para manejar el clic del botón
        boton.addActionListener(e -> {
            frame.cambiarAPanelCombate("COMBATE"); // Ir al panel de combate
        });
    ...
    public void paint(Graphics g){
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/resources/imagenes/Portada.png"));
