...
public class Panel_Combate12 extends JPanel {
    ...
    public Panel_Combate12(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Kaido3.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("CREDITOS"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            case "Gomu Gomu no Kaminari":
                mostrarGif("Luffy-Kaminari.gif");
                break;
            case "Gomu Gomu no CounterBlow":
                mostrarGif("Luffy-Counterblow.gif");
                break;
            case "Gomu Gomu no Dawn Rocket":
                mostrarGif("Luffy-Dawn Rocket.gif");
                break;
            case "Gomu Gomu no Bajrang Gun":
                mostrarGif("Luffy-Bajrang Gun.gif");
                break;
            default:
    ...
    private void mostrarGifEnemigo(String nombreAtaque) {
        ...
        switch (nombreAtaque) {
            case "Bolo Breath":
                nombreGif = "Kaido-Bolo Breath.gif";
                break;
            case "Raimei Hakke":
                nombreGif = "Kaido-Raime Hakke.gif";
                break;
            case "Ragnaraku":
                nombreGif = "Kaido-Ragnaraku.gif";
                break;
            case "Kaifu":
                nombreGif = "Kaido-Kaifu.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 500;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
