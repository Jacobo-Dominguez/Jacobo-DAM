...
public class Panel_Combate5 extends JPanel {
    ...
    public Panel_Combate5(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Enel2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE6"));
    ...
    private void mostrarGifEnemigo(String nombreAtaque) {
        ...
        switch (nombreAtaque) {
            case "El Thor":
                nombreGif = "Enel-El Thor.gif";
                break;
            case "60,0000,000 Volt Lightning Dragon":
                nombreGif = "Enel-Lightning Dragon.gif";
                break;
            case "200,000,000 Volt Amaru":
                nombreGif = "Enel-200,000,000 Volt Amaru.gif";
                break;
            case "100,0000,000 Volt Vari":
                nombreGif = "Enel-100,0000,000 Volt Vari.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
