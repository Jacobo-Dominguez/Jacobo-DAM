...
public class Panel_Combate6 extends JPanel {
    ...
    public Panel_Combate6(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Rob Lucci2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE7"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            case "Gomu Gomu no Jet Pistol":
                mostrarGif("Luffy-Jet Pistol.gif");
                break;
            ...
            case "Gomu Gomu no Jet Gatling":
                ...
                break;
            case "Gomu Gomu no Jet Combo":
                mostrarGif("Luffy-Jet Combo.gif");
                break;
            default:
    ...
    private void mostrarGifEnemigo(String nombreAtaque) {
        ...
        switch (nombreAtaque) {
            case "Shigan":
                nombreGif = "Lucci-Shigan.gif";
                break;
            case "Rokuogan":
                nombreGif = "Lucci-Rokuogan.gif";
                break;
            case "Rankyaku":
                nombreGif = "Lucci-Rankyaku.gif";
                break;
            case "Tekkai Kenpo":
                nombreGif = "Lucci-Tekkai.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 190;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
