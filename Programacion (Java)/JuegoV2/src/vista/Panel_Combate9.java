...
public class Panel_Combate9 extends JPanel {
    ...
    public Panel_Combate9(Personaje jugador, List<Personaje> enemigos, JFrame_General ventana) {
        ...
        fondo = new ImageIcon(getClass().getResource("/resources/imagenes/Fondo-Pelea-Doflamingo2.jpg")).getImage();
        ...
        botonSiguiente.addActionListener(e -> ventana.cambiarAPanelCombate("COMBATE10"));
    ...
    private void realizarAtaque(int indiceAtaque) {
        ...
        switch (nombreAtaque) {
            case "Gomu Gomu no Rhino Schneider":
                mostrarGif("Luffy-Rhino Schneider.gif");
                break;
            case "Gomu Gomu no Kong Gun":
                mostrarGif("Luffy-Kong Gun primero.gif");
                break;
            case "Gomu Gomu no Culverin":
                mostrarGif("Luffy-Culverin.gif");
                break;
            case "Gomu Gomu no King Kong Gun":
                mostrarGif("Luffy-King Kong Gun.gif");
                break;
            default:
    ...
    private void turnoEnemigo() {
        ...
        // Mostrar el GIF correspondiente al ataque del enemigo
        mostrarGifEnemigo(ataqueEnemigo.nombre);

        // Actualizar la barra de vida
        actualizarBarraVida();
    }

    private void mostrarGifEnemigo(String nombreAtaque) {
        String nombreGif = "";

        switch (nombreAtaque) {
            case "Bullet String":
                nombreGif = "Doflamingo-Bullet String.gif";
                break;
            case "God Thread":
                nombreGif = "Doflamingo-God Thread.gif";
                break;
            case "Overheat":
                nombreGif = "Doflamingo-Overheat.gif";
                break;
            case "Five Color Strings":
                nombreGif = "Doflamingo-Five Color Strings.gif";
                break;
            default:
                System.out.println("No hay GIF para este ataque.");
                return;
    ...
    private void usarObjeto() {
        ...
        if (seleccion != null) {
            ...
            if (seleccion.startsWith("Carne")) {
                ...
                jugador.vida = 270;  // Restaurar 100 puntos de vida
                if (jugador.vida > barraVidaJugador.getMaximum()) {
                    jugador.vida = barraVidaJugador.getMaximum(); // No exceder la vida máxima
                }
                actualizarBarraVida();
