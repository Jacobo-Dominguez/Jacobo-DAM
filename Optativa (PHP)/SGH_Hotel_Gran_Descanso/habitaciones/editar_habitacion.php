...
// Script para obtener los datos de las habitaciones
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($numero === '' || $precio_base === '') {
        ...
        // Comprobar que la habitacion es unica mediante el número único 
...
<form method="post" class="mt-3">
    ...
    <a class="btn btn-secondary" href="/habitaciones/listar_habitaciones.php">Cancelar</a>
</form>
